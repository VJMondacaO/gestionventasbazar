#!/usr/bin/env python3
"""
Script para crear ventas de hoy y verificar que las tarjetas del dashboard se actualicen correctamente.
"""
...
def crear_ventas_hoy():
    """Crea ventas para hoy"""
    print("Creando ventas para hoy...")
...
def main():
    ...
    try:
        # Crear ventas de hoy
        ventas_creadas = crear_ventas_hoy()
